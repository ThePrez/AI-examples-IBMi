...
SELECT OUTPUTLINE AS RESPONSE FROM TABLE (
...
-- Call watsonX with HTTP (insert your own bearer token and space ID)
values QSYS2.HTTP_POST(
    'https://us-south.ml.cloud.ibm.com/ml/v1/text/generation?version=2023-07-07',
    '{ "model_id": "meta-llama/llama-2-13b-chat","input": "What is the capital of Boston?", "parameters": { "max_new_tokens": 100, "time_limit": 1000 },"space_id": "<your space ID here>" }',
    '{"headers":{"Authorization":"Bearer <insert_your_token_here>", "Content-Type": "application/json", "Accept": "application/json"}}'
);
